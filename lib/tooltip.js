...
SimpleTooltip = (function(_super) {
  ...
  SimpleTooltip.prototype.showTooltip = function(e) {
    var distance, domSize, pointToSize, position, windowSize;
    ...
    if (position === null) {
      if (pointToSize.bottom + distance + this.arrowSize.height / 2 + this.elSize.height < windowSize.height) {
        if (pointToSize.centerX - domSize.scrollLeft - this.elSize.width / 2 < 0 && pointToSize.centerX - domSize.scrollLeft + this.elSize.width / 2 < windowSize.width) {
          position = "right";
        } else if (pointToSize.centerX - domSize.scrollLeft - this.elSize.width / 2 > 0 && pointToSize.centerX - domSize.scrollLeft + this.elSize.width / 2 > windowSize.width) {
          position = "left";
        } else {
          position = "bottom";
        }
      } else if (pointToSize.top - distance - this.arrowSize.height / 2 - this.elSize.height > 0) {
        if (pointToSize.centerX - domSize.scrollLeft - this.elSize.width / 2 < 0 && pointToSize.centerX - domSize.scrollLeft + this.elSize.width / 2 < windowSize.width) {
          position = "right";
        } else if (pointToSize.centerX - domSize.scrollLeft - this.elSize.width / 2 > 0 && pointToSize.centerX - domSize.scrollLeft + this.elSize.width / 2 > windowSize.width) {
          position = "left";
      ...
      } else if (pointToSize.left - distance - this.arrowSize.width / 2 - this.elSize.width > 0) {
        position = "left";
      } else if (pointToSize.right + distance + this.arrowSize.width / 2 + this.elSize.width < windowSize.width) {
        position = "right";
      } else {
        position = "bottom";
      }
