  ...
  SimpleTooltip.prototype.showTooltip = function(e) {
    ...
    if (position === null) {
      if (pointToSize.bottom + distance + this.arrowSize.height / 2 + this.elSize.height < windowSize.height) {
        if (pointToSize.centerX - this.elSize.width / 2 < 0 && pointToSize.centerX - this.elSize.width / 2 + this.elSize.width < windowSize.width) {
          position = "right";
        } else if (pointToSize.centerX - this.elSize.width / 2 > 0 && pointToSize.centerX - this.elSize.width / 2 + this.elSize.width > windowSize.width) {
          position = "left";
        } else {
          position = "bottom";
        }
